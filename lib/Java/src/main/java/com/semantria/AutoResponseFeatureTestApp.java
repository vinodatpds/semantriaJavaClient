...
public class AutoResponseFeatureTestApp {
	...
	{
		final String consumerKey = "f4a9add2-627c-4cd9-bf3d-08dba99cc048";
		final String consumerSecret = "fb17fecf-6919-4c98-994d-a0cee0730c00";
		...
		String userdir = System.getProperty("user.dir")+"/source.txt";//+"\\src\\main\\java\\"+DiscoveryModeTestApp.class.getPackage().getName().replace(".","\\") + "\\source.txt";
