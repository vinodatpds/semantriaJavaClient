...
public class DiscoveryModeTestApp
{
	...
	public static void main(String args[])
	{
        ...
        // AJK EDIT - simplified source.txt path
        File file = new File("src/semantriaApps/source.txt");
        if( !file.exists() )
        {
        ...
        try
        {
            ...
            while ((strLine = br.readLine()) != null)
            {
               ...
               //TRACE  System.out.println(strLine);
            }
            in.close();
        }
        catch (Exception e){
        ...
        // AJK EDIT - second status was 2002
